...
/* @ts-ignore */
import { SSE, createPayload, tMessageSchema, tConversationSchema } from '~/common/dataprovider';
import type { TResPlugin, TMessage, TConversation, TSubmission } from '~/common/dataprovider';
...
export default function useServerStream(submission: TSubmission | null) {
  ...
  useEffect(() => {
    ...
    console.info('server:server:', server);
    console.info('eventseventsevents:', events);
